...
var commands2 = require('node-milight-promise').commands2;
...
class Milight extends MilightController {
  commands(zone, value, option) {
    this.type === 'v6' ? commandsV6(zone, value, option) : commands2(value)
  }
  toggle(zone, value) {
